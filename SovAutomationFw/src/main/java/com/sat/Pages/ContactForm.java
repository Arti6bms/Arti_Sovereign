...
public class ContactForm {
	...
	public	WebElement objAge;
	
	@FindBy(xpath = "//select[@aria-label='Relationship']")
	public	WebElement objRelationship;
	
	@FindBy(xpath = "//input[@aria-label='Home Phone']")
	public WebElement objHomePhone;
	
	@FindBy(xpath = "//input[@aria-label='Mobile Phone']")
	public WebElement objMobilePhone;
	
	@FindBy(xpath = "//input[@aria-label='Mobile Phone 2']")
	public WebElement objMobilePhone2;
	
	@FindBy(xpath = "//input[@aria-label='Work Phone']")
	public WebElement objWorkPhone;
...
//		}
	...
	public void selectTaskByContact(String contact) throws InterruptedException {
		WebElement record = driver.findElement(By.xpath("(//*[contains(text(),'" + contact + "')])[1]"));
	...
	public void clickOnSave() throws InterruptedException {
		...
		System.out.print("User clicked on Save Button");
		Thread.sleep(1000);
...
//					.invisibilityOf(driver.findElement(By.xpath("//*[@role='alert'][text()='Saving...']"))));
	...
	public String readTaskTitle() throws InterruptedException {
		Thread.sleep(2000);
		maps.put("Tasktitle",driver.findElement(By.xpath("//h1[@data-id='header_title']")).getAttribute("title"));
		return driver.findElement(By.xpath("//h1[@data-id='header_title']")).getAttribute("title");
	}
	
	public String getTaskTitle() throws InterruptedException {
		Thread.sleep(2000);
		System.out.println(maps.get("Tasktitle"));
		return maps.get("Tasktitle"); 
	}
...
//		driver.findElement(By.xpath("//*[text()='GENERAL INFORMATION']")).click();
		...
		System.out.println("clicked on accounthperlink");
		Thread.sleep(5000);
...
// Data Protection Tab	
		...
		try {
			for (int i = 0; i < actual.size(); i++) {
				for (int j = 1; j < element.size() - 1; j++) {
					...
					Thread.sleep(2000);
					assertion.CheckAssertion(actual.get(i).get(j), element.get(j - 1).getText());
	...
	public void Clickoncontactname(String name) throws InterruptedException {
		...
		action.click(driver.findElement(By.xpath("//*[text()='" + name + "']"))).build().perform();
		Thread.sleep(3000);
		Wait.untilPageLoadComplete(driver,500);
	}
